...
checkpoint_dir = 'checkpoints_AGIQA3K_vit32b'
...
for session in range(0,10):
    ...
    aigc_train_loader = set_dataset_aigc_3k(aigc_train_csv, 16, aigc_set, num_workers, preprocess3, 8, False)
    aigc_val_loader = set_dataset_aigc_3k(aigc_val_csv,16, aigc_set, num_workers, preprocess2,15, True)
