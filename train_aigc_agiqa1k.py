...
checkpoint_dir = 'checkpoints_AGIQA1K_vit32b'
...
def do_batch_prompt_noresize(x, text):
    batch_size = x.size(0)
    num_patch = x.size(1)
...
for session in range(0,10):
    ...
    aigc_train_loader = set_dataset_aigc(aigc_train_csv, 16, aigc_set, num_workers, preprocess3, 8, False)
    aigc_val_loader = set_dataset_aigc(aigc_val_csv,16, aigc_set, num_workers, preprocess2,15, True)
